...
import 'contact.dart'; // Import class Contact
...
class _ContactsPageState extends State<ContactsPage> {
  final List<Contact> contacts = []; // Menggunakan List<Contact>
  ...
  void _addContact() {
    final newContact = Contact( // Menggunakan constructor Contact
      name: name,
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text('${contact.phoneNumber}, ${contact.selectedDate} ${contact.selectedFile}'), // Menampilkan tanggal dan path file
